...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   private void func_78476_b(float p_78476_1_, int p_78476_2_) {
      if(!this.field_175078_W) {
         ...
         if(this.field_78531_r.field_71474_y.field_74330_P == 0 && !flag && !this.field_78531_r.field_71474_y.field_74320_O && !this.field_78531_r.field_71442_b.func_78747_a()) {
            this.func_180436_i();
      ...
      if(this.field_78536_aa) {
         ...
         if(world != null) {
            ...
            for(int i = 0; i < 256; ++i) {
               ...
               float f16 = this.field_78531_r.field_71474_y.field_151452_as;
               float f17 = 1.0F - f8;
               float f13 = 1.0F - f9;
               float f14 = 1.0F - f10;
