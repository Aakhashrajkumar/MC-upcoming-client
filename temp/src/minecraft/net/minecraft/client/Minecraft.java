   ...
   private void func_71384_a() throws LWJGLException, IOException {
      ...
      AchievementList.field_76004_f.func_75988_a(new IStatStringFormat() {
         public String func_74535_a(String p_74535_1_) {
            try {
               return String.format(p_74535_1_, new Object[]{GameSettings.func_74298_c(Minecraft.this.field_71474_y.field_74313_G.func_151463_i())});
      ...
      if(this.field_71462_r == null || this.field_71462_r.field_146291_p) {
         ...
         while(Keyboard.next()) {
            ...
            if(Keyboard.getEventKeyState()) {
               ...
               if(this.field_71474_y.field_74329_Q && this.field_71474_y.field_181657_aC) {
                  if(k == 11) {
                     this.func_71383_b(0);
                  }
         ...
         for(int l = 0; l < 9; ++l) {
            if(this.field_71474_y.field_74324_K[l].func_151468_f()) {
               if(this.field_71439_g.func_175149_v()) {
         ...
         while(this.field_71474_y.field_74321_H.func_151468_f() && flag) {
            this.func_147108_a(new GuiChat());
         }

         if(this.field_71462_r == null && this.field_71474_y.field_151447_Z.func_151468_f() && flag) {
            this.func_147108_a(new GuiChat("/"));
         }
   ...
   public void func_152348_aa() {
      ...
      if(i != 0 && !Keyboard.isRepeatEvent()) {
         if(!(this.field_71462_r instanceof GuiControls) || ((GuiControls)this.field_71462_r).field_152177_g <= func_71386_F() - 20L) {
            if(Keyboard.getEventKeyState()) {
               if(i == this.field_71474_y.field_152397_ao.func_151463_i()) {
               ...
               } else if(i == this.field_71474_y.field_151456_ac.func_151463_i()) {
                  this.field_152353_at.func_152910_a(true);
               } else if(i == this.field_71474_y.field_178883_an.func_151463_i()) {
                  this.func_71352_k();
               } else if(i == this.field_71474_y.field_151457_aa.func_151463_i()) {
