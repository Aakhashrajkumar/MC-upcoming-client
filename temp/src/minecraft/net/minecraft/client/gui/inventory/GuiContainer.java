...
public abstract class GuiContainer extends GuiScreen {
   ...
   protected void func_73864_a(int p_73864_1_, int p_73864_2_, int p_73864_3_) throws IOException {
      ...
      boolean flag = p_73864_3_ == this.field_146297_k.field_71474_y.field_74310_D.func_151463_i() + 100;
   ...
   protected boolean func_146983_a(int p_146983_1_) {
      if(this.field_146297_k.field_71439_g.field_71071_by.func_70445_o() == null && this.field_147006_u != null) {
         for(int i = 0; i < 9; ++i) {
            if(p_146983_1_ == this.field_146297_k.field_71474_y.field_74324_K[i].func_151463_i()) {
