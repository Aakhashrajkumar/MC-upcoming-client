   ...
   public void func_147243_a(S1BPacketEntityAttach p_147243_1_) {
      ...
      if(p_147243_1_.func_149404_c() == 0) {
         ...
         if(flag) {
            ...
            this.field_147299_f.field_71456_v.func_110326_a(I18n.func_135052_a("mount.onboard", new Object[]{GameSettings.func_74298_c(gamesettings.field_151444_V.func_151463_i())}), false);
         }
   ...
   public void func_147252_a(S2BPacketChangeGameState p_147252_1_) {
      ...
      if(i == 1) {
         ...
         if(f == 0.0F) {
            ...
            this.field_147299_f.field_71456_v.func_146158_b().func_146227_a(new ChatComponentTranslation("demo.help.movement", new Object[]{GameSettings.func_74298_c(gamesettings.field_74370_x.func_151463_i()), GameSettings.func_74298_c(gamesettings.field_74368_y.func_151463_i()), GameSettings.func_74298_c(gamesettings.field_74366_z.func_151463_i()), GameSettings.func_74298_c(gamesettings.field_74314_A.func_151463_i())}));
         } else if(f == 102.0F) {
            this.field_147299_f.field_71456_v.func_146158_b().func_146227_a(new ChatComponentTranslation("demo.help.jump", new Object[]{GameSettings.func_74298_c(gamesettings.field_74311_E.func_151463_i())}));
         } else if(f == 103.0F) {
            this.field_147299_f.field_71456_v.func_146158_b().func_146227_a(new ChatComponentTranslation("demo.help.inventory", new Object[]{GameSettings.func_74298_c(gamesettings.field_74313_G.func_151463_i())}));
         }
      } else if(i == 6) {
